...
a.parentNode)if(a.matches(e))return a;return null};f.getPosition=function(a,e){for(var c=0,d=0,h=a.getBoundingClientRect(),g=a;g;){if("body"===g.tagName.toLowerCase())var n=g.scrollTop||document.documentElement.scrollTop,c=c+(g.offsetLeft-(g.scrollLeft||document.documentElement.scrollLeft)+g.clientLeft),d=d+(g.offsetTop-n+g.clientTop);else c+=g.offsetLeft-g.scrollLeft+g.clientLeft,d+=g.offsetTop-g.scrollTop+g.clientTop;g=g.offsetParent}c={x:c,y:d,rect:h};d={x:0,y:0};c.visible=!1;d=a.offsetParent;
if(null!=d){for(h=d.offsetParent;null!=h&&null!==h.offsetParent&&h.offsetHeight===h.scrollHeight;)h=h.offsetParent;d=null!=h?h.getBoundingClientRect():d.getBoundingClientRect();null==e&&(e=0);h=a.getBoundingClientRect();g=!(h.left>d.right-e||h.right<d.left+e||h.top>d.bottom-e||h.bottom<d.top+e);c.visible=g;c.frame={dx:(h.left+h.width/2-d.left)/d.width,dy:(h.top+h.height/2-d.top)/d.height};a=f(a);!g&&a.hasClass("--ui--visible")?(a.removeClass("--ui--visible"),c.event="exit"):g?g&&(a.hasClass("--ui--visible")?
c.event="scroll":(c.event="enter",a.addClass("--ui--visible"))):c.event="off-scroll"}return c};f.ZxQuery=g;Element.prototype.matches||(Element.prototype.matches=Element.prototype.matchesSelector||Element.prototype.mozMatchesSelector||Element.prototype.msMatchesSelector||Element.prototype.oMatchesSelector||Element.prototype.webkitMatchesSelector||function(a){a=(this.document||this.ownerDocument).querySelectorAll(a);for(var e=a.length;0<=--e&&a.item(e)!==this;);return-1<e});(function(){function a(e,
b){b=b||{bubbles:!1,cancelable:!1,detail:void 0};var c=document.createEvent("CustomEvent");c.initCustomEvent(e,b.bubbles,b.cancelable,b.detail);return c}if("function"===typeof window.CustomEvent)return!1;a.prototype=window.Event.prototype;window.CustomEvent=a})();String.prototype.hashCode=function(){var a=0;if(0===this.length)return a;for(var e=0;e<this.length;e++)var c=this.charCodeAt(e),a=(a<<5)-a+c,a=a|0;return a};String.prototype.startsWith||(String.prototype.startsWith=function(a,e){return this.substr(!e||
0>e?0:+e,a.length)===a});u.exports=f},{"./Logger":2,"./Util.js":4}],6:[function(l,u,z){l=l("./zuix/Zuix.js");"object"===typeof u&&u.exports?u.exports=l.call(this):this.zuix=l.call(this)},{"./zuix/Zuix.js":12}],7:[function(l,u,z){u.exports=function(a){return null}},{}],8:[function(l,u,z){function a(a,c,d){g=a;this._options=null;this.contextId=null==c||null==c.contextId?null:c.contextId;this.componentId=null;this.trigger=function(a,e,b){"function"===typeof d&&d(a,e,b)};this.behavior=this._controller=
this._style=this._css=this._view=this._model=this._container=null;this._eventMap=[];this._behaviorMap=[];this._c=null;this.options(c);return this}var k=l("../helpers/Logger")("ComponentContext.js"),h=l("./OptionAttributes")(),d=l("../helpers/ZxQuery"),c=l("../helpers/Util"),g=null;a.prototype.container=function(a){if(null==a)return this._container;a instanceof d.ZxQuery&&(a=a.get());this._container=a;return this};a.prototype.view=function(a){if("undefined"===typeof a)return this._view;a instanceof
d.ZxQuery&&(a=a.get());k.t(this.componentId,"view:attach","timer:view:start");if("string"===typeof a){a={content:a};this.trigger(this,"html:parse",a);a=a.content;var c=d.wrapElement("div",a);null!=c.firstElementChild&&(null!=c.firstElementChild.getAttribute(h.dataUiView)?1===c.children.length&&(a=c.firstElementChild.innerHTML):a=c.innerHTML);null!=this._container?(this._view=this._container,this._view.innerHTML+=a):null!=this._view?this._view.innerHTML=a:this._view=c;d(this._view).find("script").each(function(a,
...
this._controller=a;return this};a.prototype.options=function(a){if(null==a)return this._options;var c=this._options=this._options||{};d.each(a,function(a,e){c[a]=e});null!=c.componentId&&(this.componentId=c.componentId);this.container(c.container);this.view(c.view);"undefined"!==typeof c.css&&this.style(c.css);this.controller(c.controller);this.model(c.model);return this};a.prototype.on=function(a,c){this._c.on(a,c);return this};a.prototype.loadCss=function(a,h){var p=this;c.isNoU(a)&&(a={});c.isNoU(a.caching)||
(h=a.caching);var t=p.componentId+".css";c.isNoU(a.path)||(t=a.path);h||(t+="?"+(new Date).getTime());d.ajax({url:g.getResourcePath(t),success:function(d){p.style(d);c.isFunction(a.success)&&a.success.call(p,d)},error:function(d){k.e(d,p);c.isFunction(a.error)&&a.error.call(p,d)},then:function(){c.isFunction(a.then)&&a.then.call(p)}});return this};a.prototype.loadHtml=function(a,n){var p=this,t=p.componentId;c.isNoU(a)&&(a={});c.isNoU(a.caching)||(n=a.caching);c.isNoU(a.path)||(t=a.path);var f=g.store("zuix.inlineViews");
null==f&&(f=[],g.store("zuix.inlineViews",f));if(null!=f[t])p.view(f[t]),c.isFunction(a.success)&&a.success.call(p,f[t]),c.isFunction(a.then)&&a.then.call(p);else{var b=d().find("["+h.dataUiView+'="'+t+'"]:not(['+h.dataUiComponent+'*=""])');if(0<b.length()){var l=b.get(0);f[t]=l.innerHTML;p.view()===l||null!=p.container()&&p.container().contains(l)?(b.attr(h.dataUiView,null),p._view=l,this.trigger(this,"view:process",d(p.view()))):p.view(l.innerHTML);c.isFunction(a.success)&&a.success.call(p,l.innerHTML);
c.isFunction(a.then)&&a.then.call(p)}else f=c.isNoU(a.cext)?".html":a.cext,t==p.componentId&&(t+=f+(n?"":"?"+(new Date).getTime())),d.ajax({url:g.getResourcePath(t),success:function(b){p.view(b);c.isFunction(a.success)&&a.success.call(p,b)},error:function(b){k.e(b,p);c.isFunction(a.error)&&a.error.call(p,b)},then:function(){c.isFunction(a.then)&&a.then.call(p)}})}return this};a.prototype.viewToModel=function(){k.t(this.componentId,"view:model","timer:vm:start");var a=this;this._model={};d(this._view).find("["+
...
!0,b.visible=v.getPosition(b.element,J).visible):(b.lazy=!1,b.visible=!0);if(null!=b&&null!=b.element&&b.visible){a={item:b,cancelable:b.lazy};break}if(0<y.length)b=y.shift();else break}return a}function e(a){c(a);a=g();null!=a&&K.append([a])}function n(a){var b=v(a);if(null!=b.attr(r.dataUiLoaded)||0<b.parent("pre,code").length())return!1;b.attr(r.dataUiLoaded,"true");var c=b.attr(r.dataUiOptions);m.isNoU(c)?c={}:(c=m.propertyFromPath(window,c),c=m.cloneObject(c)||{});var d=b.attr(r.dataUiContext);
if(!m.isNoU(d)){var w=D.context(d);null!==w&&(c=w.options());c.contextId=d}m.isNoU(c.view)&&!b.isEmpty()?(c.view=a,c.viewDeferred=!0):m.isNoU(c.view)&&m.isNoU(c.container)&&b.isEmpty()&&(c.container=a);d=b.attr(r.dataUiLoad);if(m.isNoU(d))if(d=b.attr(r.dataUiInclude),null!=d)d=p(d),b.attr(r.dataUiInclude,d),b.attr(r.dataUiComponent,d),m.isNoU(c.controller)&&(c.controller=function(){});else return!1;else d=p(d),b.attr(r.dataUiLoad,d);w=b.attr(r.dataBindModel);!m.isNoU(w)&&0<w.length&&(c.model=m.propertyFromPath(window,
w));b=b.attr(r.dataUiPriority);m.isNoU(b)||(c.priority=parseInt(b));v(a).one("component:ready",function(){h(a);e(a)});D.load(d,c);return!0}function p(a){var b=D.store("config");null!=b&&null!=b[location.host]&&(b=b[location.host]);b=null!=b&&null!=b.libraryPath?b.libraryPath:"https://genielabs.github.io/zkit/lib/";a.startsWith("@lib/")&&(a=b+a.substring(5));return a}function t(a,b){"string"===typeof b&&(b=m.propertyFromPath(window,b));null!=a&&null!=b&&(null!=b.lazyLoad&&a.setAttribute(r.dataUiLazyload,
...
a;return this};u.exports=function(){return new a};var q=l("../helpers/Logger")("ComponentContext.js"),m=l("../helpers/Util"),v=l("../helpers/ZxQuery"),F=[],y=[],M=[],x=[],B=function(){return{element:null,priority:0,visible:!0,lazy:!1}},K=l("./../helpers/AsynChain")({doWork:function(a,b){v(a.element).one("component:ready",function(){b()});return n(a.element)},willBreak:function(){return!1},status:function(a){switch(a){case "done":e()}}}),H=!1,J=1,D=null,C=!1;navigator&&navigator.userAgent&&(C=(new RegExp(/bot|googlebot|crawler|spider|robot|crawling/i)).test(navigator.userAgent));
...
g=null;if(null!=c.on)for(var e in c.on)c.on.hasOwnProperty(e)&&(g=c.on[e],d.addEvent(e,g));if(null!=c.behavior)for(var l in c.behavior)c.behavior.hasOwnProperty(l)&&(g=c.behavior[l],d.addBehavior(l,g));a.controller().call(this,this);return this}var k=l("../helpers/ZxQuery");a.prototype.addEvent=function(a,d){this.mapEvent(this.context._eventMap,this.view(),a,d);return this};a.prototype.addBehavior=function(a,d){this.mapEvent(this.context._behaviorMap,this.view(),a,d);return this};a.prototype.field=
...
(c._fieldCache[a]=d,1===d.length()&&m.isNoU(d.field))){var e=this;d.field=function(a){return e.field(a,d,d)}}}else d=c._fieldCache[a];return d}function d(a){var b=zuix.store("config");null!=b&&null!=b[location.host]&&(b=b[location.host]);a=x.resolvePath(a);!a.startsWith("//")&&0>a.indexOf("://")&&(a=(null!=b&&null!=b.resourcePath?b.resourcePath:"")+a);return a}function c(a,c){var d=f(a.componentId);null!==d&&null==c.controller&&null==a.controller()&&(a.controller(d.controller),q.t(a.componentId+":js",
"component:cached:js"));if(m.isNoU(c.view)){if(null!==d&&(null!=d.view&&(a.view(d.view),q.t(a.componentId+":html","component:cached:html")),!1!==c.css&&(c.css=!1,d.css_applied||(d.css_applied=!0,a.style(d.css),q.t(a.componentId+":css","component:cached:css")))),m.isNoU(a.view()))return P("resource-loader").queue(a.componentId+":html",function(){A[a.componentId]=this;a.loadHtml({cext:c.cext,caching:I,success:function(e){null==d&&(d=E(a));d.view=e;delete d.controller;!1!==c.css?(A[a.componentId].step(a.componentId+
